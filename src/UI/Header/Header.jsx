  ...
  return (
    <header className={styles.header}>
      <div className={styles.logo_portal}>
        <ul className={styles.logo}><li className={styles.logo_letter}>A</li>
      ...
      <div className={styles.social_network}><ul>
        <li><a href='#'><img src={facebook} alt="facebook" /></a></li>
        <li><a href="#"><img src={instagram} alt="instagram" /></a></li>
        <li><a href="#"><img src={pinterest} alt="pinterest" /></a></li>
        <li><a href="#"><img src={linkedin} alt="linkedin" /></a></li>
        <li><a href="#"><img src={skype} alt="skype" /></a></li>
        <li><a href="#"><img src={google} alt="google plus" /></a></li>
        <li ><a href="#"><img src={twitter} alt="twitter" /></a></li>
      </ul></div>
      <div className={styles.sign_in}><img src={sign} alt="sign-in" /><p><a href='#'>Вхід</a></p></div>
    </header>
  )
}
